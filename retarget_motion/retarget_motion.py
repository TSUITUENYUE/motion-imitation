...
REF_HIP_JOINT_IDS = [2, 7, 13, 17] 
REF_TOE_JOINT_IDS = [10, 20, 14, 24]
...
mocap_motions = [
  ...
  ["german_walk", "new_data/data/full_seq/german/joint_pos.txt", 62, 63],
]
...
def main():
  ...
  while True:
    for mocap_motion in mocap_motions:
      ...
      print("joint_pos_data.shape=", joint_pos_data.shape)
      ...
      output_motion(retarget_frames, f"../retarget_result/{mocap_motion[0]}.txt")
